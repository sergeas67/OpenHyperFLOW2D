# OpenOpenHyperFLOW2D project (Version  1.0.0)
# Written by  Serge A. Suchkov (ss@e1.bmstu.ru)
include   ../.version
include   ../.compiler
include   ../.parallel
include   ../.models
...
SOURCES_2D  = hyper_flow_bound.cpp \
	      ...
	      hyper_flow_solid_bound_circle.cpp \
...
OBJECTS_2D  = hyper_flow_bound.o \
	      ...
	      hyper_flow_solid_bound_circle.o \
...
INCLUDES_2D = hyper_flow2d.hpp \
	      ...
	      hyper_flow_solid_bound_circle.hpp \
