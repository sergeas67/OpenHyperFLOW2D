...
enum     NodeType2D {
    NT_UNDEF_2D      = 0,                                            // Undefined node type
    ...
    NT_D0X_2D        = CT_NODE_IS_SET_2D | CT_dRodx_NULL_2D | CT_dUdx_NULL_2D | CT_dVdx_NULL_2D | CT_dTdx_NULL_2D  |
                       CT_dYdx_NULL_2D,                              // Non-gradient condition  (dF/dx = 0) in x direction
    ...
    NT_D0Y_2D        = CT_NODE_IS_SET_2D | CT_dRody_NULL_2D | CT_dUdy_NULL_2D | CT_dVdy_NULL_2D   | CT_dTdy_NULL_2D |
                       CT_dYdy_NULL_2D,                              // Non-gradient condition  (dF/dy = 0) in y direction
    ...
    NT_FARFIELD_2D   = NT_FC_2D | CT_NONREFLECTED_2D                 // Non-reflected far-field BC
};
...
// Neighboring nodes
   ...
   ~FlowNode2D() {
    ...
    void TurbModRANS2D(int is_mu_t, int is_init, TurbulenceExtendedModel tem, T delta = 0.);
